...
function AquagymApp() {
    return (
        <>
            <div>SNT</div>
            <h1>L'aquagym</h1>
            <Link href="https://conseilsport.decathlon.fr/aquagym-5-bonnes-raisons-de-sinscrire-a-des-seances">
            ...
            <Link href="https://sante.journaldesfemmes.fr/fiches-sante-du-quotidien/2703409-bienfaits-de-l-aquagym-pour-la-sante-contre-indication-frequence/">
